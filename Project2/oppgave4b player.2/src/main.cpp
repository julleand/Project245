...
namespace game
{
  ...
  int paddle2Y = 20; // Initial Y position of player 2 paddle
...
bool isMaster = false;
constexpr int Gruppenr = 2;           // Set this to your Player 2 group number
constexpr int MotstanderGruppenr = 1; // Group number of Player 1
...
void loop()
{
  // Check if Player 2 has pressed the joystick button to become the master
...
void handleCANInput()
{
  ...
  {
    // If message is from Player 1 controlling paddle movements
    ...
    // If message is the ball position update from Player 1
